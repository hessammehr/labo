...
from app.routers import auth, attachments, entries, events, files, indigo, notebooks, permissions, scoped_tokens, search, users
...
app.include_router(indigo.router, prefix="/api")
